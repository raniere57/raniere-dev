...
export const tools: ToolDefinition[] = [
  ...
  },
  {
    ...
    description: 'Valida dígito verificador — BB, Bradesco, Itaú, Caixa, Santander, Nubank, Inter, Sicoob e Sicredi.',
    keywords: ['conta', 'banco', 'agencia', 'digito', 'brasil', 'nubank', 'inter', 'sicoob', 'sicredi'],
    status: 'available',
    mark: '🏦',
  },
  {
  ...
  },
  {
    ...
    category: 'validadores',
    name: 'Validador CNH',
    description: 'Valida registro de CNH (11 dígitos, módulo 11).',
    keywords: ['cnh', 'habilitacao', 'detran', 'motorista'],
    status: 'available',
    mark: 'CNH',
  },
  {
    ...
    category: 'validadores',
    name: 'Validador CNS',
    description: 'Cartão Nacional de Saúde — definitivo (1/2) e provisório (7/8/9).',
    keywords: ['cns', 'sus', 'saude', 'cartao'],
    status: 'available',
    mark: 'CNS',
  },
  {
    ...
    category: 'validadores',
    name: 'Certidão civil',
    description: 'Matrícula CNJ de nascimento, casamento ou óbito (32 dígitos, mod 97).',
    keywords: ['certidao', 'nascimento', 'casamento', 'obito', 'cartorio', 'cnj'],
    status: 'available',
    mark: 'CRT',
  },
  {
    ...
    description: 'Valida placa Mercosul (ABC1D23) e formato antigo (ABC1234).',
    keywords: ['placa', 'veiculo', 'mercosul', 'detran', 'carro'],
    status: 'available',
    mark: 'PL',
  },
  {
