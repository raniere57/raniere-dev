...
export const tools: ToolDefinition[] = [
  ...
  },
  {
    id: 'br-contact',
    category: 'validadores',
    name: 'E-mail / telefone BR',
    description: 'Valide e-mails e telefones brasileiros — com opção de correção automática.',
    keywords: ['email', 'e-mail', 'telefone', 'celular', 'contato', 'brasil', 'ddd'],
    status: 'available',
    mark: '@',
  },
  {
    ...
    category: 'validadores',
    name: 'Validador CEP',
    description: 'Valida CEP e consulta logradouro, bairro e cidade via ViaCEP.',
    keywords: ['cep', 'endereco', 'postal', 'brasil', 'correios'],
    status: 'available',
    mark: 'CEP',
  },
  {
    id: 'pis',
    category: 'validadores',
    name: 'Validador PIS / PASEP',
    description: 'Valida NIS/PIS/PASEP com dígito verificador e formatação.',
    keywords: ['pis', 'pasep', 'nis', 'inss', 'brasil'],
    status: 'available',
    mark: 'PIS',
  },
  {
    id: 'pix',
    category: 'validadores',
    name: 'Validador chave PIX',
    description: 'Detecta e valida chaves PIX — CPF, CNPJ, e-mail, telefone e aleatória.',
    keywords: ['pix', 'chave', 'cpf', 'cnpj', 'bacen', 'brasil'],
    status: 'available',
    mark: 'PIX',
  },
  {
    id: 'credit-card',
    category: 'validadores',
    name: 'Validador cartão de crédito',
    description: 'Algoritmo de Luhn e detecção de bandeira (Visa, Master, Amex…).',
    keywords: ['cartao', 'credito', 'luhn', 'visa', 'mastercard'],
    status: 'available',
    mark: '💳',
  },
  {
    id: 'bank-account',
    category: 'validadores',
    name: 'Conta bancária BR',
    description: 'Valida dígito verificador de conta — BB, Bradesco, Itaú, Caixa e Santander.',
    keywords: ['conta', 'banco', 'agencia', 'digito', 'brasil'],
    status: 'available',
    mark: '🏦',
  },
  {
    id: 'renavam',
    category: 'validadores',
    name: 'Validador RENAVAM',
    description: 'Valida Registro Nacional de Veículos Automotores (11 dígitos).',
    keywords: ['renavam', 'veiculo', 'carro', 'placa', 'detran'],
    status: 'available',
    mark: 'RV',
  },
  {
    ...
    description: 'Valida título eleitoral com algoritmo do TSE (12 dígitos).',
    keywords: ['titulo', 'eleitor', 'tse', 'eleicao', 'brasil'],
    status: 'available',
    mark: 'TE',
  },
  {
